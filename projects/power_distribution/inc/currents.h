...
typedef enum {
  ...
  FRONT_POWER_DISTRIBUTION_CURRENT_INFOTAINMENT_DISPLAY,
  ...
  FRONT_POWER_DISTRIBUTION_CURRENT_FAN_1,
  FRONT_POWER_DISTRIBUTION_CURRENT_FAN_2,
  ...
  FRONT_POWER_DISTRIBUTION_CURRENT_SPARE_3,

  // Currents for rear power distribution
  REAR_POWER_DISTRIBUTION_CURRENT_BMS,
  ...
  REAR_POWER_DISTRIBUTION_CURRENT_BRAKE_LIGHT,
  REAR_POWER_DISTRIBUTION_CURRENT_STROBE,
  REAR_POWER_DISTRIBUTION_CURRENT_FAN_1,
  REAR_POWER_DISTRIBUTION_CURRENT_FAN_2,
