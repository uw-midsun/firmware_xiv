""" This Module Tests methods in can_util.c """
import unittest
...
class TestCanPack(unittest.TestCase):
    ...
    def test_multiple_inputs(self):
        ...
        self.assertEqual(b'\x00\x00\x00\x00\x00\x00\x00\x00', can_pack(data_list=zero_list))
        self.assertEqual(b'\xFF\xFF', can_pack(data_list=[(255, 1), (255, 1)]))
        max_list = [(255, 1), (255, 1), (255, 1), (255, 1), (255, 1), (255, 1), (255, 1), (255, 1)]
        self.assertEqual(b'\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF', can_pack(data_list=max_list))
        ...
        self.assertEqual(b'\x01\x6d\x63\xb8\x89\x97', can_pack(data_list=arbitrary_list))
