...
class TestI2CWrite(unittest.TestCase):
    ...
    def test_send_message(self, mock_next_message, mock_send_message):
        ...
        self.assertEqual(8, self.babydriver_id)
        self.assertEqual([0, 10, 1, 3, 1], self.data)
        ...
        i2c_write(1, 0, [7, 5, 12], 1)
        self.assertEqual(8, self.babydriver_id)
        self.assertEqual([1, 0, 3, 1, 1], self.data)
        self.assertEqual(None, self.channel)
        self.assertEqual(BABYDRIVER_CAN_MESSAGE_ID, self.msg_id)
        self.assertEqual(BABYDRIVER_DEVICE_ID, self.device_id)
        ...
        i2c_write(1, 10, [0])
        self.assertEqual(8, self.babydriver_id)
        self.assertEqual([1, 10, 1, 0], self.data)
        self.assertEqual(None, self.channel)
        self.assertEqual(BABYDRIVER_CAN_MESSAGE_ID, self.msg_id)
        self.assertEqual(BABYDRIVER_DEVICE_ID, self.device_id)
        ...
        self.assertEqual(8, self.babydriver_id)
        self.assertEqual([1, 10, 3, 1, 0], self.data)
        self.assertEqual(None, self.channel)
        self.assertEqual(BABYDRIVER_CAN_MESSAGE_ID, self.msg_id)
        self.assertEqual(BABYDRIVER_DEVICE_ID, self.device_id)
        ...
        i2c_write(1, 10, [7, 5, 12], 1)
        self.assertEqual(8, self.babydriver_id)
        self.assertEqual([1, 10, 3, 1], self.data)
        self.assertEqual(None, self.channel)
        self.assertEqual(BABYDRIVER_CAN_MESSAGE_ID, self.msg_id)
        self.assertEqual(BABYDRIVER_DEVICE_ID, self.device_id)
        ...
        self.assertEqual(8, self.babydriver_id)
        self.assertEqual([1, 255, 3, 1], self.data)
        self.assertEqual(None, self.channel)
        self.assertEqual(BABYDRIVER_CAN_MESSAGE_ID, self.msg_id)
        self.assertEqual(BABYDRIVER_DEVICE_ID, self.device_id)
        ...
        self.assertEqual(8, self.babydriver_id)
        self.assertEqual([1, 10, 3, 255], self.data)
        self.assertEqual(None, self.channel)
        self.assertEqual(BABYDRIVER_CAN_MESSAGE_ID, self.msg_id)
        self.assertEqual(BABYDRIVER_DEVICE_ID, self.device_id)
