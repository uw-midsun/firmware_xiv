...
#define POWER_SELECT_CELL_VSENSE_SCALING 1000    // mV/V -- todo figure out what this should be
...
typedef enum {
  ...
  POWER_SELECT_FAULT_MAIN_OV,
  POWER_SELECT_FAULT_AUX_OC,
  POWER_SELECT_FAULT_DCDC_OC,
  POWER_SELECT_FAULT_MAIN_OC,
...
#define POWER_SELECT_LTC_DISABLE_FAULT_MASK \
  ((1 << POWER_SELECT_FAULT_AUX_OC) | (1 << POWER_SELECT_FAULT_MAIN_OC))
