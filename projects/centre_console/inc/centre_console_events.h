...
typedef enum {
  DRIVE_EVENT_NEUTRAL = NUM_POWER_MAIN_SEQUENCE_EVENTS,  // 16
  DRIVE_EVENT_PARKING,
  DRIVE_EVENT_REVERSE,
  DRIVE_EVENT_PARKING_CHARGING,
  DRIVE_EVENT_DRIVE,
  DRIVE_EVENT_MCI_RELAYS_CLOSED,
  DRIVE_EVENT_MCI_RELAYS_OPENED,
  DRIVE_EVENT_MCI_EBRAKE_PRESSED,
  DRIVE_EVENT_MCI_EBRAKE_RELEASED,
...
typedef enum {
  BATTERY_HEARTBEAT_EVENT_HEALTH_CHECK_REQUEST = NUM_DRIVE_FSM_EVENTS,
