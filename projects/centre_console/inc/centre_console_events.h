...
typedef enum {
  ...
  DRIVE_FSM_INPUT_EVENT_MCI_OUTPUT_SET_DESTINATION_DRIVE,
  DRIVE_FSM_INPUT_EVENT_MCI_OUTPUT_SET_DESTINATION_REVERSE,
  DRIVE_FSM_INPUT_EVENT_MCI_OUTPUT_SET_DESTINATION_NEUTRAL_PARKING,
