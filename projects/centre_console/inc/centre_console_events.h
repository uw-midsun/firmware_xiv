...
typedef enum {
  ...
  NUM_CENTRE_CONSOLE_POWER_EVENTS  // 10
} CentreConsolePowerEvent;

typedef enum {
  POWER_AUX_SEQUENCE_EVENT_BEGIN = NUM_CENTRE_CONSOLE_POWER_EVENTS,  // 10
  ...
  NUM_POWER_AUX_SEQUENCE_EVENTS  // 15
} PowerAuxSequenceEvent;

typedef enum {
  POWER_MAIN_SEQUENCE_EVENT_BEGIN = NUM_POWER_AUX_SEQUENCE_EVENTS,  // 15
...
typedef enum {
  BATTERY_HEARTBEAT_EVENT_HEALTH_CHECK_REQUEST = NUM_POWER_MAIN_SEQUENCE_EVENTS,
