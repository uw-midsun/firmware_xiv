...
static MciDriveFsmEvent s_drive_output_fsm_map[] = {
  [EE_DRIVE_OUTPUT_OFF] = MCI_DRIVE_FSM_EVENT_OFF_STATE,
  [EE_DRIVE_OUTPUT_DRIVE] = MCI_DRIVE_FSM_EVENT_DRIVE_STATE,
  [EE_DRIVE_OUTPUT_REVERSE] = MCI_DRIVE_FSM_EVENT_REVERSE_STATE
};
...
FSM_STATE_TRANSITION(state_off) {
  FSM_ADD_GUARDED_TRANSITION(MCI_DRIVE_FSM_EVENT_DRIVE_STATE, prv_guard_throttle, state_drive);
  FSM_ADD_GUARDED_TRANSITION(MCI_DRIVE_FSM_EVENT_REVERSE_STATE, prv_guard_throttle, state_reverse);
}

FSM_STATE_TRANSITION(state_drive) {
  FSM_ADD_TRANSITION(MCI_DRIVE_FSM_EVENT_OFF_STATE, state_off);
  FSM_ADD_TRANSITION(MCI_DRIVE_FSM_EVENT_REVERSE_STATE, state_reverse);
}

FSM_STATE_TRANSITION(state_reverse) {
  FSM_ADD_TRANSITION(MCI_DRIVE_FSM_EVENT_OFF_STATE, state_off);
  FSM_ADD_TRANSITION(MCI_DRIVE_FSM_EVENT_DRIVE_STATE, state_drive);
}
