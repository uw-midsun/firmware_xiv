...
ifneq (,$(filter clean lint lint_quick pylint format format_quick build_all test_all test_format socketcan update_codegen babydriver pytest_all pytest install_requirements,$(MAKECMDGOALS)))
