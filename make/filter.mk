...
ifneq (,$(filter fastmpxe mpxe mpxei clean lint lint_quick pylint format format_quick build_all\
          test_all test_format socketcan update_codegen babydriver,$(MAKECMDGOALS)))
