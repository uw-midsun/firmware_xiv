...
ifneq (,$(filter clean lint lint_quick pylint format format_quick build_all test_all test_format socketcan update_codegen babydriver test_all_python test_python,$(MAKECMDGOALS)))
