...
#define TEST_MOSI_PIN { .port = GPIO_PORT_B, 15 }
#define TEST_MISO_PIN { .port = GPIO_PORT_B, 14 }
#define TEST_SCLK_PIN { .port = GPIO_PORT_B, 13 }
#define TEST_CS_PIN { .port = GPIO_PORT_B, 12 }
...
// TODO: add a test for CR if Micah says we need it, I guess.
