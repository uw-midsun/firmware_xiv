...
// Takes in an array of input bytes |encoded| of size |encoded_len| and an output array |decoded|
// where |decoded_len| points to storage initially set to the maximum size of |encoded|.
// After decoding, |decoded_len| is set to the size of the decoded output.
