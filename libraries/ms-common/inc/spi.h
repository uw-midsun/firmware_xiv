...
// CS will be pulled high. As a rule of thumb, this method should be used in simple
// transactions where at most one TX is required, followed by at most one RX.
