...
// Note that this API does not support overwriting flash - once written, data must be cleared
// by erasing the entire page before rewriting.
//
// address must be aligned to FLASH_WRITE_BYTES and buffer_len must be a multiple of
// FLASH_WRITE_BYTES
