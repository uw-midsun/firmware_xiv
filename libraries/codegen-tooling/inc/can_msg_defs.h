...
typedef enum {
  ...
  SYSTEM_CAN_MESSAGE_REGEN_BRAKING = 11,
  SYSTEM_CAN_MESSAGE_READY_TO_DRIVE = 13,
  SYSTEM_CAN_MESSAGE_RELAY_OPEN_OK_5_MPPTS = 14,
  SYSTEM_CAN_MESSAGE_RELAY_OPEN_OK_6_MPPTS = 15,
  ...
  SYSTEM_CAN_MESSAGE_REGEN_BRAKING_TOGGLE_REQUEST = 46,
  SYSTEM_CAN_MESSAGE_RACE_NORMAL_STATUS = 47,
  ...
  SYSTEM_CAN_MESSAGE_RACE_NORMAL_SWITCH_MODE = 56,
