...
#define CAN_TRANSMIT_DRIVE_OUTPUT(throttle_u16, direction_u16,                 \
                                  cruise_control_u16,                          \
                                  mechanical_brake_state_u16)                  \
  ({                                                                           \
    CanMessage msg = {0};                                                      \
    CAN_PACK_DRIVE_OUTPUT(&msg, (throttle_u16), (direction_u16),               \
...
#define CAN_TRANSMIT_BATTERY_VT(module_id_u16, voltage_u16, temperature_u16)   \
  ({                                                                           \
    CanMessage msg = {0};                                                      \
    CAN_PACK_BATTERY_VT(&msg, (module_id_u16), (voltage_u16),                  \
                        (temperature_u16));                                    \
    StatusCode status = can_transmit(&msg, NULL);                              \
    status;                                                                    \
  })
...
#define CAN_TRANSMIT_MOTOR_VELOCITY(vehicle_velocity_left_u16,                 \
                                    vehicle_velocity_right_u16)                \
  ({                                                                           \
    CanMessage msg = {0};                                                      \
    CAN_PACK_MOTOR_VELOCITY(&msg, (vehicle_velocity_left_u16),                 \
                            (vehicle_velocity_right_u16));                     \
    StatusCode status = can_transmit(&msg, NULL);                              \
    status;                                                                    \
  })
...
#define CAN_TRANSMIT_CHARGER_INFO(current_u16, voltage_u16, status_bitset_u16) \
  ({                                                                           \
    CanMessage msg = {0};                                                      \
    CAN_PACK_CHARGER_INFO(&msg, (current_u16), (voltage_u16),                  \
                          (status_bitset_u16));                                \
    StatusCode status = can_transmit(&msg, NULL);                              \
    status;                                                                    \
  })
