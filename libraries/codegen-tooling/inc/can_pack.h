...
#define CAN_PACK_MOTOR_SINK_TEMPS(msg_ptr, motor_temp_l_u16_ptr, sink_temp_l_u16_ptr, \
                                  motor_temp_r_u16_ptr, sink_temp_r_u16_ptr)          \
  can_pack_impl_u16((msg_ptr), SYSTEM_CAN_DEVICE_MOTOR_CONTROLLER,                    \
                    SYSTEM_CAN_MESSAGE_MOTOR_SINK_TEMPS, 8, (motor_temp_l_u16_ptr),   \
                    (sink_temp_l_u16_ptr), (motor_temp_r_u16_ptr), (sink_temp_r_u16_ptr))

#define CAN_PACK_DSP_BOARD_TEMPS(msg_ptr, dsp_board_temp_l_u32_ptr, dsp_board_temp_r_u32_ptr) \
  can_pack_impl_u32((msg_ptr), SYSTEM_CAN_DEVICE_MOTOR_CONTROLLER,                            \
                    SYSTEM_CAN_MESSAGE_DSP_BOARD_TEMPS, 8, (dsp_board_temp_l_u32_ptr),        \
                    (dsp_board_temp_r_u32_ptr))
