...
#define CAN_UNPACK_AUX_BATTERY_STATUS_MAIN_POWER_VOLTAGE(                                      \
    msg_ptr, aux_voltage_u16_ptr, aux_current_u16_ptr, aux_temp_u16_ptr, main_voltage_u16_ptr) \
  can_unpack_impl_u16((msg_ptr), 8, (aux_voltage_u16_ptr), (aux_current_u16_ptr),              \
                      (aux_temp_u16_ptr), (main_voltage_u16_ptr))

#define CAN_UNPACK_DCDC_BATTERY_STATUS_MAIN_POWER_CURRENT(                                        \
    msg_ptr, dcdc_voltage_u16_ptr, dcdc_current_u16_ptr, dcdc_temp_u16_ptr, main_current_u16_ptr) \
