...
void setup_test(void) {
  ...
  ads1015_init(&s_storage, TEST_ADS1015_I2C_PORT, TEST_ADS1015_ADDR,
               &ready_pin);
...
void test_ads1015_init_invalid_input(void) {
  ...
  TEST_ASSERT_EQUAL(STATUS_CODE_OK,
                    ads1015_init(&s_storage, TEST_ADS1015_I2C_PORT,
                                 TEST_ADS1015_ADDR, &ready_pin));
...
void test_ads1015_config_channel_invalid_input(void) {
  ...
  TEST_ASSERT_EQUAL(STATUS_CODE_OK, ads1015_configure_channel(
                                        &s_storage, ADS1015_CHANNEL_0, true,
                                        prv_callback_channel,
                                        &s_callback_called[ADS1015_CHANNEL_0]));
  // Tests disabling a channel.
  TEST_ASSERT_EQUAL(STATUS_CODE_OK, ads1015_configure_channel(
                                        &s_storage, ADS1015_CHANNEL_0, false,
                                        prv_callback_channel,
                                        &s_callback_called[ADS1015_CHANNEL_0]));
  ...
  TEST_ASSERT_EQUAL(STATUS_CODE_INVALID_ARGS,
                    ads1015_configure_channel(
                        NULL, ADS1015_CHANNEL_1, true, prv_callback_channel,
...
void test_ads1015_read_invalid_input(void) {
  ...
  TEST_ASSERT_EQUAL(STATUS_CODE_OK,
                    ads1015_read_raw(&s_storage, ADS1015_CHANNEL_2, &reading));
  // Tests for s_storage being null.
  TEST_ASSERT_EQUAL(STATUS_CODE_INVALID_ARGS,
                    ads1015_read_converted(NULL, ADS1015_CHANNEL_2, &reading));
  TEST_ASSERT_EQUAL(STATUS_CODE_INVALID_ARGS,
                    ads1015_read_raw(NULL, ADS1015_CHANNEL_2, &reading));
...
void test_ads1015_channel_callback(void) {
  ads1015_configure_channel(&s_storage, ADS1015_CHANNEL_0, true,
                            prv_callback_channel,
                            &s_callback_called[ADS1015_CHANNEL_0]);
  ads1015_configure_channel(&s_storage, ADS1015_CHANNEL_1, false,
                            prv_callback_channel,
                            &s_callback_called[ADS1015_CHANNEL_1]);
  ads1015_configure_channel(&s_storage, ADS1015_CHANNEL_2, true,
                            prv_callback_channel,
                            &s_callback_called[ADS1015_CHANNEL_2]);
  ads1015_configure_channel(&s_storage, ADS1015_CHANNEL_3, false,
                            prv_callback_channel,
