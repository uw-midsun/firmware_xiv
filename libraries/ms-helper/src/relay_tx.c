...
static SystemCanDevice s_device_lookup[NUM_EE_RELAY_IDS] = {
  ...
  [EE_RELAY_ID_BATTERY] = SYSTEM_CAN_DEVICE_BABYDRIVER,
  [EE_RELAY_ID_MOTOR_CONTROLLER] = SYSTEM_CAN_DEVICE_BABYDRIVER,
  [EE_RELAY_ID_SOLAR] = SYSTEM_CAN_DEVICE_BABYDRIVER
};
