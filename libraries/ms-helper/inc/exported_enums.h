...
#define EE_BATTERY_HEARTBEAT_STATE_FAULT_LTC_AFE_CELL (1 << EE_BATTERY_HEARTBEAT_FAULT_SOURCE_LTC_AFE_CELL)
#define EE_BATTERY_HEARTBEAT_STATE_FAULT_LTC_AFE_TEMP (1 << EE_BATTERY_HEARTBEAT_FAULT_SOURCE_LTC_AFE_TEMP)
#define EE_BATTERY_HEARTBEAT_STATE_FAULT_LTC_AFE_FSM (1 << EE_BATTERY_HEARTBEAT_FAULT_SOURCE_LTC_AFE_FSM)
#define EE_BATTERY_HEARTBEAT_STATE_FAULT_LTC_ADC (1 << EE_BATTERY_HEARTBEAT_FAULT_SOURCE_LTC_ADC)
