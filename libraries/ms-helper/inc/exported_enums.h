...
#define EE_BATTERY_HEARTBEAT_STATE_FAULT_KILLSWITCH (1 << EE_BATTERY_HEARTBEAT_FAULT_SOURCE_KILLSWITCH)
#define EE_BATTERY_HEARTBEAT_STATE_FAULT_CURRENT_SENSE_AFE_CELL (1 << EE_BATTERY_HEARTBEAT_FAULT_SOURCE_LTC_AFE_CELL)
#define EE_BATTERY_HEARTBEAT_STATE_FAULT_CURRENT_SENSE_AFE_TEMP (1 << EE_BATTERY_HEARTBEAT_FAULT_SOURCE_LTC_AFE_TEMP)
#define EE_BATTERY_HEARTBEAT_STATE_FAULT_CURRENT_SENSE_AFE_FSM (1 << EE_BATTERY_HEARTBEAT_FAULT_SOURCE_LTC_AFE_FSM)
#define EE_BATTERY_HEARTBEAT_STATE_FAULT_CURRENT_SENSE_ADC (1 << EE_BATTERY_HEARTBEAT_FAULT_SOURCE_LTC_ADC)
#define EE_BATTERY_HEARTBEAT_STATE_FAULT_ACK_TIMEOUT (1 << EE_BATTERY_HEARTBEAT_FAULT_SOURCE_ACK_TIMEOUT)
