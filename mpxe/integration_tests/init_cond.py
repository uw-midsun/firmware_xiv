...
def pca9539r_init_conditions():
    NUM_PCA_PINS = 16
    pca9539r_msg = mpxe.protogen.pca9539r_pb2.MxPca9539rStore()
    pca9539r_msg.state.extend([0] * NUM_PCA_PINS)
    for i in range(NUM_PCA_PINS):
        pca9539r_msg.state[i] = i % 2

    pca9539r_mask = mpxe.protogen.pca9539r_pb2.MxPca9539rStore()
    ...
    pca9539r_msg2 = mpxe.protogen.pca9539r_pb2.MxPca9539rStore()
    pca9539r_msg2.state.extend([0] * NUM_PCA_PINS)
    for i in range(NUM_PCA_PINS):
        pca9539r_msg2.state[i] = ((i + 1) % 2)

    pca9539r_mask2 = mpxe.protogen.pca9539r_pb2.MxPca9539rStore()
